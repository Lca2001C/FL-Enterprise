...
class Contrato(Base):
    ...
    nivel_escalonamento_cobranca: Mapped[int] = mapped_column(BigInteger, nullable=False, server_default="0")
    dias_atraso_acumulado: Mapped[int] = mapped_column(BigInteger, nullable=False, server_default="0")
